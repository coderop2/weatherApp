...
import static com.example.android.weatheria.data.contants_funcs.isMetric;
...
public class weathercontent {
    private static final String LOG_TAG = contants_funcs.class.getSimpleName();
    ...
    public static String formatTemperature(Context context, double temperature) {
        ...
        if (!contants_funcs.isMetric(context)) {
    ...
    public static String getFormattedWind(Context context, float windSpeed, float degrees) {
        ...
        int windFormat = R.string.windformat_kmh;

        if (!contants_funcs.isMetric(context)) {
            windFormat = R.string.windformat_mph;
