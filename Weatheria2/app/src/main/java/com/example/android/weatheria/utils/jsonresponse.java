...
/**
 * Created by harshitkhandelwal on 20/08/18.
 */
...
public final class jsonresponse {
        ...
        public static String[] getSimpleWeatherStringsFromJson(Context context, String forecastJsonStr)
            ...
            long startDay = dateutils.getNormalizedUtcDateForToday();
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                description = weathercontent.getStringForWeatherCondition(context, weatherId);
                JSONObject temperatureObject = dayForecast.getJSONObject(OWM_TEMPERATURE);
                high = temperatureObject.getDouble(OWM_MAX);
                low = temperatureObject.getDouble(OWM_MIN);
                highAndLow = weathercontent.formatHighLows(context, high, low);
        ...
        /* Is there an error? */
            ...
            contants_funcs.setLocationDetails(context, cityLatitude, cityLongitude);
...
//        long normalizedUtcStartDay = SunshineDateUtils.normalizeDate(now);
            ...
            for (int i = 0; i < jsonWeatherArray.length(); i++) {
                ...
                weatherValues.put(WeatherContract.WeatherEntry.COLUMN_HUMIDIDTY, humidity);
                weatherValues.put(WeatherContract.WeatherEntry.COLUMN_PRESSURE, pressure);
                weatherValues.put(WeatherContract.WeatherEntry.COLUMN_WIND_SPEED, windSpeed);
                weatherValues.put(WeatherContract.WeatherEntry.COLUMN_DEGREES, windDirection);
                weatherValues.put(WeatherContract.WeatherEntry.COLUMN_MAX_TEMP, high);
                weatherValues.put(WeatherContract.WeatherEntry.COLUMN_MIN_TEMP, low);
                weatherValues.put(WeatherContract.WeatherEntry.COLUMN_WEATHERID, weatherId);
